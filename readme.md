...
```bash
npm install --save render-dead-by-daylight-build@^1.0.0
```
...
```bash
yarn add render-dead-by-daylight-build@^1.0.0
```
...
```bash
npm install --save @jaid/render-dead-by-daylight-build@^1.0.0
```
